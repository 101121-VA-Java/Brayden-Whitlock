...
////		cd.edit(new Customer(1, "Brayden", "user", "pass", "ogarlette0@bravesites.com", "3578903365519546", false, null));
//	}
//
//	@Test
//	public void getAllCheck() {
//		List<Customer> expected = new ArrayList<Customer>();
//		expected.add(new Customer(1, "Brayden", "user", "pass", "ogarlette0@bravesites.com", "3578903365519546", false,
//				new Customer(1)));
...
//	}
	...
	public void addCustomerValid() {
		Mockito.when(cd.add(new Customer(2, "Laurella", "customer", "pass", "lhaggar1@opera.com", "3536516899323010", false,
				new Customer(1)))).thenReturn(2);
		int expected = 2;
		int actual = 0;
		try {
			actual = cs.add(new Customer(2, "Laurella", "customer", "pass", "lhaggar1@opera.com", "3536516899323010", false,
					new Customer(1)));
...
//		Customer expected = new Customer(1, "Brayden", "user", "pass", "ogarlette0@bravesites.com", "3578903365519546",
//				false, new Customer(1));
